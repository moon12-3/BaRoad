...
public class TripPost5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_trip_post5, container, false);
        ...
        docu.add(new MapModel("크루즈 나고야", "아이치현 나고야시 니시구 노리타케 신마치 3-1-36", 35.17912138344272, 136.8812170452505, "", "", 2L));
        docu.add(new MapModel("나고야항 수족관", "나고야시 나카구 혼마루 1-1", 35.184759864649145, 136.89967567428155, "", "", 3L));
        docu.add(new MapModel("리니어, 철도관", "나고야시 나카구 산노마루1-2-3~5", 35.1829209326055, 136.89935482526073, "", "", 4L));
