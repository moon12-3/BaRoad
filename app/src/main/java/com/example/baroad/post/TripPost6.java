...
public class TripPost6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_trip_post6, container, false);
        ...
        docu.add(new MapModel("아츠타 호라이켄 본점", "1 Chome-1-4 Meieki, Nakamura Ward, Nagoya, Aichi", 35.17091527561959, 136.88153439890988, "", "", 1L));

        List<MapModel> docu2 = new ArrayList<>();
        docu2.add(new MapModel("이자카야 고미토리 본점", "1 Chome-1-4 Meieki, Nakamura Ward, Nagoya, Aichi", 35.17091527561959, 136.88153439890988, "", "", 1L));

        view.findViewById(R.id.add_cos1).setOnClickListener(v->{
        ...
        view.findViewById(R.id.add_cos2).setOnClickListener(v->{
            db.collection("users").document(auth.getCurrentUser().getEmail())
                    .collection("plan").add(plan)
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        @Override
